package com.mark.nnb.notifications.config;
...
public class RabbitMQConfig {
    ...
    RabbitMQConfig(ApplicationProperties properties) {
        System.out.println("from rabbit mq class....");
    ...
    public AmqpAdmin pimAmqpAdmin(ConnectionFactory connectionFactory) {
        ...
        rabbitAdmin.declareQueue(newOrdersQueue());
        rabbitAdmin.declareQueue(errorOrdersQueue());
        return rabbitAdmin;
    }
}
